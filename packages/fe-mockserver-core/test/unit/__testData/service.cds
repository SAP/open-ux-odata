...
annotate RootElement with @UI: {
  LineItem                      : [
    ...
    {
      Value: Sibling.isBoundAction1Hidden,
      Label: 'Sibling isBoundAction2 Hidden'
    },
    {
      $Type        : 'UI.DataFieldForAction',
      Label        : 'Bound Action 2',
...
annotate SubElement with @UI: {LineItem: [
  {Value: SubProp1},
  {
    Value: owner.isBoundAction1Hidden,
    Label: 'Owner -> boundAction1 Hidden'
  },
  {
    $Type        : 'UI.DataFieldForAction',
    Label        : 'Bound Action 1',
  ...
  {
    Value: owner.Sibling.isBoundAction2Hidden,
    Label: 'Owner -> Sibling boundAction2 Hidden'
  },
  {
    $Type        : 'UI.DataFieldForAction',
    Label        : 'Bound Action 2',
  ...
  {
    Value: Sibling.isBoundAction4Hidden,
    Label: 'Sibling boundAction4 Hidden'
  },
  {
    $Type        : 'UI.DataFieldForAction',
...
service ActionVisibility {
  @odata.draft.enabled
  entity RootElement as projection on core.RootElement
    actions {
