...
service TestService {
    ...
    entity DraftRoot {
        key ID                                : String;
            ...
            @Core.Description: '1:1 to a draft node, with incomplete referential constraint'
            _toDraftNodeIncompleteConstraint  : Composition of one DraftNode;
            ...
            @Core.Description: '1:n to a draft node, with referential constraint'
            _toDraftNodesIncompleteConstraint : Composition of many DraftNode
                                                    on _toDraftNodesIncompleteConstraint._up = $self;
