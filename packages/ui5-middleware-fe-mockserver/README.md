...
- resolveExternalServiceReferences : whether or not to try to resolve all services referenced in `Common.ValueListReferences` annotations or CodeList annotations and serve their metadata from `localServices` directory.
